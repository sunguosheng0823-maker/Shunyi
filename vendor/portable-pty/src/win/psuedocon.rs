    ...
    pub fn new(size: COORD, input: FileDescriptor, output: FileDescriptor) -> Result<Self, Error> {
        ...
        let result = unsafe {
            (CONPTY.CreatePseudoConsole)(
                ...
                // Shunyi starts independent terminals with their own cursor position.
                // Inheriting the host cursor blocks resize/close until a remote DSR
                // reply arrives, and can deadlock headless clients entirely.
